...
// basic regex for any comm channels
              //   /\<span class\=\"ansi\-[A-Za-z]*\"\>(\[[\-|\+]\])\[([-A-Za-z]*)\] (.*)\<\/span\>/g
var channelRegex = /(\[[\-|\+]\])\[([-A-Za-z]*)\] (.*)/g;

var channelSub = { 'type' : 'channel', 'pattern' : /(\<span class\=\"ansi\-[A-Za-z]*\"\>)(\[[\-|\+]\])\[([-A-Za-z]*)\] (.*)(\<\/span\>)/g, 'replacement' : '$1<span data-channel-name="$3" title="click to have future $3 go to its own window" class="filterable">$2[$3]</span> $4$5'};
...
var ip_regex = /(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)/g;
